...
The different tasks as well as the reaction of the target area to the target object will be described in section \ref{sec:tasks}. %\ref ?
...
\todo[inline, color=yellow]{Anna}
To introduce the user to the system there will be a teaching in the learning room. When the program will be started informations will be shown next to the controller, like in the following figure. 
