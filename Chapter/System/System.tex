...
\textcolor{red}{Ab hier bitte nochmal jemand drüberlesen}
All instructions and steps of the selfteaching are saved in an external CSV-file, see following figure. 

\begin{figure}[H] 
	\center 
	\includegraphics[width=12cm]{Images/selfteachingCSV.JPG}
